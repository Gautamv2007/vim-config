...
For adding this file in ubuntu follow the below steps:
1. cd ~/.config
2. mkdir nvim
3. nvim init.lua
4. Inside the file copy paste this code(If you know how to do it.)
5. Save the file and type the command :source
6. Finally you can make any changes you want.
